...
\begin{enumerate}
 ...
 ("{\bf Expenses Guidelines}")\ignorespaces
            \BLOCK{ endif }.
            \BLOCK{ if expensePreApprovalPrice is defined }
            ...
            \BLOCK{ endif }
            \BLOCK{ if invoiceFrequency != 'at the end of the project'}
                The Consultant shall submit to the Client itemized
                \VAR{
                    {
                        'on a Weekly Basis':'weekly',
                        'on a Bi-Weekly Basis':'bi-weekly',
                ...
                \VAR{
                    {
                        ...
                        'on a Bi-Weekly Basis':'14 days',
                        'on a Monthly Basis':'month'
                    }[invoiceFrequency]
                }.
            \BLOCK{ else }
            ...
            \BLOCK{ endif }
        \BLOCK{endif}
        \item \underline{Payments}. The Client shall pay to the Consultant amounts shown on each statement or invoice described in Section 3(a) and 3(b) within \VAR{invoicePaymentPeriodWord} (\VAR{invoicePaymentPeriod}) days after receipt thereof.Â Payment after the payment deadline will incur a non-compounding late fee of \VAR{invoiceFee}\% per month on the outstanding amount.
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}[(1)]
            ...
            \item The Consultant acknowledges that the Client from time to time may have agreements with other persons or with the United States Government, or agencies thereof, that impose obligations or restrictions on the Client regarding inventions made during the course of work under such agreements or regarding the confidential nature of such work.Â  The Consultant agrees to be bound by all such obligations and restrictions that are known to Consultant and to take all action necessary to discharge the obligations of the Client under such agreements.
        \end{enumerate}
    ...
    \begin{enumerate}
        ...
        not required to attend regular meetings at the Client.Â  However, upon reasonable notice, the \VAR{consultantWithWithoutEmployes} shall meet with representatives of the Client at a location to be designated by the parties to this Agreement.
        ...
        the authority to control and direct the performance of the details of the services, the Client being interested only in the results obtained.Â  However, the services contemplated by the Agreement must meet the Clientâs standards and approval and shall be subject to the Clientâs general right of inspection and supervision to secure their satisfactory completion.
        \item The \VAR{consultantWithWithoutEmployes} shall not use the Clientâs trade names, trademarks, service names or service marks without the prior approval of the Client.
        \item The \VAR{consultantWithWithoutEmployes} shall be solely responsible for all state and federal income taxes, unemployment insurance and social security taxes in connection with this Agreement and for maintaining adequate workersâ compensation insurance coverage.
    \end{enumerate}
    \item \underline{Non-Exclusivity and Competition}.
    The \VAR{consultantWithWithoutEmployes} retains the right to contract with other companies or entities for Consultant's consulting services without restriction. The Client retains a right to contract with other companies and/or individuals for consulting services without restriction.
    \item \underline{Remedies}. The
    \VAR{
            {
                'Consultant and its Employees':'Consultant and its Employees acknowledge',
                'Consultant': 'Consultant acknowledges'
            }[consultantWithWithoutEmployes]
        }
...
\end{center}
\begin{enumerate}
    \item \BLOCK{if canConsultantUseWork=='will'} % I have to put the \item in front other wise I get an error in the preview
